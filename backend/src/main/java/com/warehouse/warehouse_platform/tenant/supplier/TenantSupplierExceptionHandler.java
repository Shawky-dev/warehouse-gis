...
@RestControllerAdvice(assignableTypes = TenantSupplierController.class)
public class TenantSupplierExceptionHandler {

    @ExceptionHandler(TenantSupplierManagementException.class)
    public ResponseEntity<ErrorResponse> handleSupplierException(TenantSupplierManagementException exception) {
