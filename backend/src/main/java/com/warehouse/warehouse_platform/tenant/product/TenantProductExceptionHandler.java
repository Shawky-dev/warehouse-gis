...
@RestControllerAdvice(assignableTypes = TenantProductController.class)
public class TenantProductExceptionHandler {

    @ExceptionHandler(TenantProductManagementException.class)
    public ResponseEntity<ErrorResponse> handleProductException(TenantProductManagementException exception) {
