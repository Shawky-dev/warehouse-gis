...
@RestControllerAdvice(assignableTypes = TenantAuditController.class)
public class TenantAuditExceptionHandler {

    @ExceptionHandler(TenantAuditException.class)
    public ResponseEntity<ErrorResponse> handleAuditException(TenantAuditException exception) {
