...
@RestControllerAdvice(assignableTypes = TenantCategoryController.class)
public class TenantCategoryExceptionHandler {

    @ExceptionHandler(TenantCategoryManagementException.class)
    public ResponseEntity<ErrorResponse> handleCategoryException(TenantCategoryManagementException exception) {
